...
**Installation update (Apr 29, 2016):** ``grizli`` has been tested within the newly-released `"astroconda" <http://astroconda.readthedocs.io/en/latest/>`__ environment, which should now provide the easiest way to obtain and maintain all of the external and STScI dependencies.
