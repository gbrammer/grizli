...
GRISM_MAJOR = {'G102':0.1, 'G141':0.1, 'G800L':0.1, 'F090W':0.1, 'F115W':0.1, 'F150W':0.1, 'F140M':0.1, 'F158M':0.1, 'F200W':0.1, 'F277W':0.2, 'F356W':0.2, 'F444W':0.2, 'BLUE':0.1, 'RED':0.1}
...
try:
    ...
    print('NB: Couldn\'t `import pyds9`.  The `utils.DS9` object will be broken')
    ds9_obj = object
